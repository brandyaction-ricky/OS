          ...
          >
            ...
            <div className="meeting-phases">
              <button
                ...
                onClick={() =>
                  document
                    .getElementById("meeting-prepare")
              ...
              <button
                type="button"
                className={transcript ? "done" : "active"}
                onClick={() =>
                  document
                    .getElementById("meeting-transcript")
                    ?.scrollIntoView({ behavior: "smooth", block: "start" })
                }
              >
                <b>2</b> 진행·전사
              ...
              <button
                type="button"
                className={structured ? "done" : ""}
                onClick={() =>
                  document
                    .getElementById("meeting-actions")
                    ?.scrollIntoView({ behavior: "smooth", block: "start" })
                }
              >
                <b>3</b> 결정·실행
