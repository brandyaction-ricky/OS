...
export function PlaceholderPage({ title, stage }: { title: string; stage: string }) {
  return (
    <>
      <header className="page-header"><div className="page-title-group"><span className="eyebrow">NEXT PLANNING SLICE</span><h1>{title}</h1><p>{stage} 영역의 상세 기획을 받아 현재 서버 구조 위에 연결할 예정입니다.</p></div></header>
