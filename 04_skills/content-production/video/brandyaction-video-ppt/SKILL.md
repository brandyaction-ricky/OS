...
`CONTENT.md`, Longform Process, `youtube-production-v2` 공정 정의, `longform-edit`·`longform-thumbnail`·`longform-publish` 최신 Process Wiki, 승인 원고·낭독본, 촬영 자산 포인터, Automation Run 상태와 Company/Brand Wiki를 읽는다.
...
- PDF 원본 8공정과 썸네일 폐쇄 루프의 최신 Wiki를 포함한다.
