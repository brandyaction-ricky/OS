...
const REMOVED_INTERNAL_TERMS = [
  /대상\s*a/gi,
  /모방\s*욕망/gi,
  /개성화/gi,
  /contents?[-_ ]script/gi,
  /gate\s*0/gi,
  /보이스\s*앵커\s*캘리브레이션/gi,
  /통념\s*채집/gi,
] as const;

export const PUBLIC_COPY_GUIDANCE = "시청자에게 보이는 제목·카피·본문은 쉬운 일상어로 작성. 배선·대상a·결핍·증환·개성화·모방욕망·contents-script·GATE·보이스 앵커 캘리브레이션·통념 채집 등 내부 분석·제작 용어를 그대로 출력하지 말고 시청자의 상황과 행동으로 풀어 쓴다.";
